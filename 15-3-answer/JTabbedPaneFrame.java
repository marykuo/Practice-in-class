...
import ballbouncing.BallWorld;
import audioplayer.Sound;
...
public class JTabbedPaneFrame extends JFrame  
{
   ...
   public JTabbedPaneFrame()
   {
      ...
      Sound.play("src/audioplayer/audio/sample.au"); //play music
      ...
      // set up panel ballworld and add it to JTabbedPane
      BallWorld ballworld = new BallWorld(900, 800); // create second panel
      tabbedPane.addTab( "BallWorld", null, ballworld, "0607 add Panel" ); 
