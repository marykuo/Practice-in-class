...
public class DrawPanel extends JPanel implements MouseListener, MouseMotionListener{
	...
	public void randgen(int n) {
		...
		for(int i=0;i<n;i++){
			...
			switch(shapeType){
			case RECT:
				shapes[shapeCount++] = new Rect(x1,y1,x2,y2,color,color2, filled, gradient);
				break;
			case OVAL:
				shapes[shapeCount++] = new Oval(x1,y1,x2,y2,color,color2, filled, gradient);
				break;
			case VTRI:
				shapes[shapeCount++] = new VTriangle(x1,y1,x2,y2,color,color2,filled, gradient);
				break;
			}
		}		
	   repaint();
	...
	public void mousePressed(MouseEvent e) {
	    ...
	    switch(shapeType){
	    case RECT:
	    	currentShape = new Rect(x1,y1,x2,y2,color,color2,filled, gradient);
	    	break;
	    case SQUARE:
	    	currentShape = new Square(x1,y1,x2,y2,color,color2,filled, gradient);
	    	break;
	    case OVAL:
	    	currentShape = new Oval(x1,y1,x2,y2,color,color2, filled, gradient);
	    	break;
	    case CIRCLE:
	    	currentShape = new Circle(x1,y1,x2,y2,color,color2, filled, gradient);
	    	break;
	    case VTRI:
	    	currentShape = new VTriangle(x1,y1,x2,y2,color, color2, filled, gradient);
	    	break;
	    case TICTACTOE:
	...
	public void mouseReleased(MouseEvent e) {
		...
		case RECT:
			...
			break;
		case SQUARE:
			shapes[shapeCount++] = new Square(x1,y1,x2,y2,color,color2,filled, gradient);
			break;			
		case OVAL:
			shapes[shapeCount++] = new Oval(x1,y1,x2,y2,color,color2, filled, gradient);
			break;
